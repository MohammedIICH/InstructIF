 ...
 * @author mdeoliveir
 */
public class obtenirHistoriqueEleve extends Action {
    public obtenirHistoriqueEleve(Service service) {
        super(service);
    }
    ...
    public void executer(HttpServletRequest request) {
        ...
        List<Soutien> listeSoutiens = service.getHistoriqueSoutiensEleve(eleve, sortingType);
