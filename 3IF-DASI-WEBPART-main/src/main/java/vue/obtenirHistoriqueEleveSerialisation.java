 ...
 * @author mdeoliveir
 */
public class obtenirHistoriqueEleveSerialisation extends Serialisation {
    ...
    public void appliquer(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (Soutien s : listeSoutien) {
            ...
            jsonSoutien.addProperty("intervenant", s.getIntervenant().getPrenom() + " " + s.getIntervenant().getNom());
            ...
            System.out.println(gson.toJson(jsonListeSoutien));
