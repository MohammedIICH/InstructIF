 ...
 * @author mdeoliveir
 */
public class EvaluerCoursSerialisation extends Serialisation {
    ...
    public void appliquer(HttpServletRequest request, HttpServletResponse response) {
        ...
        JsonArray jsonRate = new JsonArray();
        
        JsonObject jsonState = new JsonObject();
        jsonState.addProperty("isEvaluated", success);
        jsonRate.add(jsonState);
        
        jsonContainer.add("evaluation", jsonRate);
